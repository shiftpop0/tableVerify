...
plt.plot(x, y_ingress, marker='s', markersize=6, linestyle='-', color='blue', label='single switch')
...
# 设置图表标题和标签
plt.xlabel('Number of Border Switch', fontsize=20, fontweight='bold')
plt.ylabel('Load(%)', fontsize=20, fontweight='bold')
plt.xlim(2, 12)
...
plt.savefig('C:/Users/Administrator/OneDrive/吴欣泽/Paper/数据中心版/Fig1/'+'border.png', transparent=True)
plt.show()
